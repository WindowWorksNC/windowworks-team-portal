...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.tr-video{position:relative;padding-bottom:56.25%;height:0;margin-bottom:18px;border-radius:8px;overflow:hidden;background:#1a1a1a;max-width:760px}',
      '.tr-video iframe,.tr-video video{position:absolute;top:0;left:0;width:100%;height:100%;border:0;background:#1a1a1a}',
      '.tr-body{background:#fff;border:1px solid #e4dbd0;border-radius:8px;padding:30px 36px;margin-bottom:16px;max-width:760px}',
      ...
      '.tr-p{font-size:16.5px;line-height:1.68;color:#242424;margin:0 0 15px}',
      '.tr-ul,.tr-ol{font-size:16.5px;line-height:1.68;color:#242424;margin:0 0 15px;padding-left:22px}',
      '.tr-ul li,.tr-ol li{margin-bottom:8px}',
      '.tr-bq{border-left:3px solid #c4581f;background:#faf6f0;margin:0 0 16px;padding:15px 18px;font-size:16.5px;line-height:1.62;color:#3a3a3a}',
      ...
      '.tr-quiz{background:#fff;border:1px solid #e4dbd0;border-radius:8px;padding:24px 28px;max-width:760px}',
